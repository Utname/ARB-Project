...
@Component({
  selector: 'sys_khoaPopupAdd',
  templateUrl: './popupAdd.component.html',
  styleUrls: ['./popupAdd.component.css']
})
export class sys_khoaPopupAddComponent extends BasePopUpAddComponent {

  constructor(public dialogRef: MatDialogRef<sys_khoaPopupAddComponent>,
    ...
    super(_translocoService, service,route, "", http, 'sys_khoa', dialogRef, dialogModal)
    this.record = data;
